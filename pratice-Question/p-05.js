 ...
 */
    ...
    const emailCheck = users.every( user => user.email);
 ...
 */
    ...
    const ipCheck = users.filter(({ip_address}) => ip_address.split('.')[0]<128);
       // console.log(ipCheck);
 ...
 */
    ...
    const findIndx  = users.findIndex(({ip_address}) =>{
 ...
 */
    ...
    const findSoundemail = users.find(({email}) => email.includes('soundcloud'));
       // console.log(findSoundemail);
